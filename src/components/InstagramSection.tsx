            ...
            <div className="max-w-[1400px] mx-auto px-4 md:px-8">
                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    <a
                        ...
                        className="flex items-center gap-1.5 text-xs font-bold text-gray-500 hover:text-pink-600 transition-colors cursor-pointer"
                    >
                    ...
                    <>
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2 md:gap-3">
                            {posts.map((post) => (
                                ...
                                >
                                    ...
                                    {/* Hover overlay */}
                                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-end justify-end p-2"
                        ...
                        <div className="flex justify-center mt-6">
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-2 text-white text-sm font-bold px-6 py-2.5 rounded-full shadow-lg hover:opacity-90 hover:shadow-xl active:scale-95 transition-all cursor-pointer"
